    ...
    return (
        <div id="Address-Header">
            <div id='Address-Top'>
                    ...
                    <div id="Address-Top-Title">
                        Veuillez entrer votre adresse de livraison
                    </div>
                    <div id='Address-Top-NextStep'>
                        {props.haveAddress === true ? 
                        <button id='Address-Top-NextStep-Button' onClick={()=> navigate('/checkout-payment')}>Passer au paiement</button>
                        :
                        <button id='Address-Top-NextStep-Button-Disable' disabled >Passer au paiement</button>
                        }
                    </div>
            </div>
        </div>
