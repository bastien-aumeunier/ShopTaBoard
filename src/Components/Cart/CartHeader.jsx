        ...
        <div id="Cart-Header">
            <div id='Panier-Top'>
                    ...
                    <div id='Panier-Top-NextStep'>
                       {props.quantity >0 ?
                         <button id='Panier-Top-NextStep-Button' onClick={()=> navigate('/checkout-address')}>Passer à l'étape suivante</button>
                         :
                         <button id='Panier-Top-NextStep-Button-Disable' disabled>Passer à l'étape suivante</button>   
                    }
                    </div>
            </div>
        </div>
